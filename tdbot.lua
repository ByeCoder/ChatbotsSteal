...
function getInputChatPhoto(file) 
local input = tostring(file) 
local infile = {} 
if input:match('.jpg') then 
infile = {["@type"] = 'inputChatPhotoStatic' , photo = {["@type"] = 'inputFileLocal', path = file}} 
elseif input:match('.mp4') then 
infile = {["@type"] = 'inputChatPhotoAnimation' , animation = {["@type"] = 'inputFileLocal', path = file}} 
end 
return infile 
end 
